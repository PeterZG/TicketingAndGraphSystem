...
public class FlowerSystem {
    private static final int ROSE_SHIPMENT_DELAY = 2;
    ...
    private FlowerBox<RoseSeedling, Rose> roseBox = new FlowerBox<>();
    // TODO for students: Add in appropriate generic parameter
    private FlowerBox<SunflowerSeedling, Sunflower> sunflowerBox = new FlowerBox<>();
